...
# -----------------------------
# HIDE DEFAULT SIDEBAR NAV & ADD CUSTOM SIDEBAR
# -----------------------------
...
# Create custom sidebar with logo and navigation
with st.sidebar:
    # --- LOGO ---
    logo_path = Path(__file__).parent / "assets" / "spotify_logo.png"
        ...
        ">
            ...
            <div>
                <div style="
                    ...
                    line-height: 1.2;
                ">
                    Spotify <span style="color: #1DB954;">Analyzer</span>
                </div>
                <div style="
                    color: #B3B3B3;
                    font-size: 0.7rem;
    ...
    # --- NAVIGATION ITEMS ---
    # Define navigation with icons and labels
    nav_items = [
        {"icon": "🏠", "label": "Home", "page": "app"},
        {"icon": "📊", "label": "Overview", "page": "1_Overview"},
        {"icon": "♫", "label": "Song Explorer", "page": "3_Song_Explorer"},
        {"icon": "🎤", "label": "Artists", "page": "2_Artists"},
        {"icon": "🎭", "label": "Genres", "page": "4_Genres"},
        {"icon": "📈", "label": "Trends", "page": "5_Trends"},
        {"icon": "🤖", "label": "ML Predictor", "page": "6_ML_Predictor"},
    ]
    ...
    for item in nav_items:
        ...
        # Create clickable nav item using st.button for reliable navigation
